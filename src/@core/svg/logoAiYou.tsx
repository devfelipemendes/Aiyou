...
interface IconSolidProps {
  ...
  /**
   * The color of the icon (default: #76b800)
   */
  ...
  /**
   * The width and height of the icon (default: 24)
   */
  size?: number
}

const LogoAiyou: React.FC<IconSolidProps> = ({ color = '#76b800', className = '', size = 24 }) => {
  return (
    <svg
      id='Camada_2'
      data-name='Camada 2'
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 571.65 329.8'
      className={`icon-solid ${className}`}
      width={size}
      height={size}
      aria-hidden='true'
      role='img'
