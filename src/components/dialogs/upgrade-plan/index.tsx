      ...
      <Dialog fullWidth open={open} onClose={handleClose} closeAfterTransition={false}>
        <DialogTitle variant='h4' className='flex flex-col gap-2 text-center sm:pbs-16 sm:pbe-6 sm:pli-16'>
          ...
          <Typography component='span' className='flex flex-col text-center'>
            Escolha o plano que melhor se adeque aos seus objetivos
          </Typography>
        </DialogTitle>
        <DialogContent className='overflow-visible pbs-0 sm:pli-16 sm:pbe-16'>
          ...
          <div className='flex items-center gap-4 flex-col sm:flex-row'>
            <FormControl fullWidth size='small'>
              ...
              >
                <MenuItem value='Basic'>Basico - R$ 40/Mês</MenuItem>
                <MenuItem value='Standard'>Standard - R$ 99/Mês</MenuItem>
                <MenuItem value='Enterprise'>Enterprise - R$ 499/Mês</MenuItem>
                <MenuItem value='Company'>Company - R$ 999/Mês</MenuItem>
              </Select>
            </FormControl>
          ...
          <div className='flex flex-col gap-1'>
            <Typography>O Seu plano atual é o Standard</Typography>
